...
/**
 * 和MetricUtil的区别是：前者需要提供Supplier接口实现，不能声明异常，新的版本替换为Callable接口
 * @author liyibo
 * @date 2025-10-28 10:38
 */
@Slf4j
public final class MetricUtil2 {
     ...
     * @param <T>
     */
    public static <T> T metric(Callable<T> targetMethod, MetricTagSetter<T> tagSetter) throws Exception {
